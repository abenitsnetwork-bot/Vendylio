// The Terms of Service body, shared by the /terms page and the acceptance
// modal in onboarding so a seller reads the exact text they accept.
// Version constants live in @/lib/legal/terms (a plain module) so server
// routes can import them without React.
export { TERMS_VERSION, TERMS_LAST_UPDATED } from '@/lib/legal/terms';
